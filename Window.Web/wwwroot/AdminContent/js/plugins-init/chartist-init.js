 ...
 var dzChartlist = function(){
	...
	var svgAnimationChart = function(){
		...
		var chart = new Chartist.Line('#svg-animation', {
			labels: ['شنبه', '1شنبه', '2شنبه', '3شنبه', '4شنبه'],
			series: [
			  [1, 5, 2, 5, 4, 3],
			  [2, 3, 4, 8, 1, 2],
			  [5, 4, 3, 2, 1, 0.5]
	...
	var overlappingBarsChart = function(){
		...
		var data = {
			labels: ['فرور', 'اردی', 'خردا', 'تیر', 'مردا', 'شهر', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند'],
			series: [
	...
	var multiLineChart = function(){
		...
		new Chartist.Bar('#multi-line-chart', {
			labels: ['سه ماهه اول سال', 'سه ماهه دوم سال', 'سه ماهه سوم سال', 'سه ماهه چهارم سال'],
			series: [
	...
	var extremeChart = function(){
		...
		new Chartist.Bar('#extreme-chart', {
			labels: ['ربع 1','ربع 2', 'ربع 3', 'ربع 4'],
			series: [
			  [5, 4, 3, 7],
			  [3, 2, 9, 5],
			  [1, 5, 8, 4],
