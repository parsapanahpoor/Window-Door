    ...
    public partial class InitialUserTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1m, new DateTime(2022, 6, 7, 9, 51, 33, 872, DateTimeKind.Local).AddTicks(4145), false, "Admin", "Admin" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreateDate", "IsDelete", "RoleUniqueName", "Title" },
                values: new object[] { 2m, new DateTime(2022, 6, 7, 9, 51, 33, 872, DateTimeKind.Local).AddTicks(4169), false, "Support", "Support" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreateDate", "IsDelete", "RoleUniqueName", "Title" },
                values: new object[] { 3m, new DateTime(2022, 6, 7, 9, 51, 33, 872, DateTimeKind.Local).AddTicks(4180), false, "Seller", "Seller" });
